...
<?php } if ($this->_rootref['S_FORUM_RULES']) {  ?>
	...
	<div class="text-red-cont text-red">
...
<?php } if ($this->_rootref['S_NO_READ_ACCESS']) {  ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_B_END'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_B_END'] : ''; ?>

	<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_F_BEGIN'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_F_BEGIN'] : ''; ?>&nbsp;<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_F_END'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_F_END'] : ''; ?>

	<?php } if ($_topicrow_val['S_FIRST_ROW'] || ! $_topicrow_val['S_TOPIC_TYPE_SWITCH']) {  ?>

	<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_H_BEGIN'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_H_BEGIN'] : ''; if ($this->_rootref['S_DISPLAY_ACTIVE']) {  echo ((isset($this->_rootref['L_ACTIVE_TOPICS'])) ? $this->_rootref['L_ACTIVE_TOPICS'] : ((isset($user->lang['ACTIVE_TOPICS'])) ? $user->lang['ACTIVE_TOPICS'] : '{ ACTIVE_TOPICS }')); } else if ($_topicrow_val['S_TOPIC_TYPE_SWITCH'] && ( $_topicrow_val['S_POST_ANNOUNCE'] || $_topicrow_val['S_POST_GLOBAL'] )) {  echo ((isset($this->_rootref['L_ANNOUNCEMENTS'])) ? $this->_rootref['L_ANNOUNCEMENTS'] : ((isset($user->lang['ANNOUNCEMENTS'])) ? $user->lang['ANNOUNCEMENTS'] : '{ ANNOUNCEMENTS }')); } else { echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); } echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_H_END'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_H_END'] : ''; ?>

	<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_B_BEGIN'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_B_BEGIN'] : ''; ?>
