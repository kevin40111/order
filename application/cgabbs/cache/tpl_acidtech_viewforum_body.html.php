		...
		<tr>
			...
			<?php } if ($this->_rootref['S_IS_POSTABLE']) {  if ($this->_rootref['TOTAL_TOPICS']) {  ?>
				...
				<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" width="100%">
					<?php if ($this->_rootref['S_WATCH_FORUM_LINK']) {  ?><a href="<?php echo (isset($this->_rootref['S_WATCH_FORUM_LINK'])) ? $this->_rootref['S_WATCH_FORUM_LINK'] : ''; ?>"><?php echo (isset($this->_rootref['S_WATCH_FORUM_TITLE'])) ? $this->_rootref['S_WATCH_FORUM_TITLE'] : ''; ?></a> <?php if ($this->_rootref['U_MARK_TOPICS'] && sizeof($this->_tpldata['topicrow'])) {  ?>| <?php } } if ($this->_rootref['U_MARK_TOPICS'] && sizeof($this->_tpldata['topicrow'])) {  ?><a href="<?php echo (isset($this->_rootref['U_MARK_TOPICS'])) ? $this->_rootref['U_MARK_TOPICS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MARK_TOPICS_READ'])) ? $this->_rootref['L_MARK_TOPICS_READ'] : ((isset($user->lang['MARK_TOPICS_READ'])) ? $user->lang['MARK_TOPICS_READ'] : '{ MARK_TOPICS_READ }')); ?></a> <?php } if ($this->_rootref['TOTAL_TOPICS']) {  ?><br /><?php $this->_tpl_include('pagination.html'); } ?>
