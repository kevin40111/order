...
<tr>
	<th colspan="3"><?php echo ((isset($this->_rootref['L_ADD_NEW_RULE'])) ? $this->_rootref['L_ADD_NEW_RULE'] : ((isset($user->lang['ADD_NEW_RULE'])) ? $user->lang['ADD_NEW_RULE'] : '{ ADD_NEW_RULE }')); ?></th>
</tr>
...
<table class="tablebg" width="100%" cellspacing="1">
<tr>
	<th colspan="6"><?php echo ((isset($this->_rootref['L_DEFINED_RULES'])) ? $this->_rootref['L_DEFINED_RULES'] : ((isset($user->lang['DEFINED_RULES'])) ? $user->lang['DEFINED_RULES'] : '{ DEFINED_RULES }')); ?></th>
</tr>
...
<?php if ($this->_rootref['S_FOLDER_OPTIONS']) {  ?>
	...
	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<th colspan="2"><?php echo ((isset($this->_rootref['L_RENAME_FOLDER'])) ? $this->_rootref['L_RENAME_FOLDER'] : ((isset($user->lang['RENAME_FOLDER'])) ? $user->lang['RENAME_FOLDER'] : '{ RENAME_FOLDER }')); ?></th>
	</tr>
	<tr>
...
<table class="tablebg" width="100%" cellspacing="1">
<tr>
	<th colspan="2"><?php echo ((isset($this->_rootref['L_ADD_FOLDER'])) ? $this->_rootref['L_ADD_FOLDER'] : ((isset($user->lang['ADD_FOLDER'])) ? $user->lang['ADD_FOLDER'] : '{ ADD_FOLDER }')); ?></th>
</tr>
...
<?php if ($this->_rootref['S_FOLDER_OPTIONS']) {  ?>
	...
	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<th colspan="3"><?php echo ((isset($this->_rootref['L_REMOVE_FOLDER'])) ? $this->_rootref['L_REMOVE_FOLDER'] : ((isset($user->lang['REMOVE_FOLDER'])) ? $user->lang['REMOVE_FOLDER'] : '{ REMOVE_FOLDER }')); ?></th>
	</tr>
	<tr>
...
<table class="tablebg" width="100%" cellspacing="1">
<tr>
	<th colspan="2"><?php echo ((isset($this->_rootref['L_FOLDER_OPTIONS'])) ? $this->_rootref['L_FOLDER_OPTIONS'] : ((isset($user->lang['FOLDER_OPTIONS'])) ? $user->lang['FOLDER_OPTIONS'] : '{ FOLDER_OPTIONS }')); ?></th>
</tr>
<tr>
