<div class='row-fluid'>
    <div class='span12'>
        <a class='btn btn-primary' data-role='button' data-toggle='modal' href='#new-order'><i class='icon-shopping-cart icon-white'></i> 開團</a>
    </div>
</div>
<div class='row-fluid'>
    <div class="span12">
        <table class='table'>
            ...
            <tbody>
                ...
                <tr data-id='<?= $order->id?>'>
                    ...
                    <td><?= $order->member?></td>
                    <td><?= date("Y-m-d H:i", strtotime($order->expire_time))?></td>
                    <td>
...
<div id='new-order' class='modal fade hide'>
    ...
    <div class='modal-footer'>
        ...
        <button id='close' class='btn'><i class='icon-eject'></i> 取消</button>
    </div>
</div>
